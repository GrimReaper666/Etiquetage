...
public:
    ...
    Sommet<VertexType, ArcType> debut, fin;
    ArcType valeur;

    Arete(int clef, const Sommet<VertexType, ArcType> &debut, const Sommet<VertexType, ArcType> &fin, const ArcType &v) : GElement(clef), debut(debut), fin(fin), valeur(v) {}
     ...
     */
    bool estEgal(const Sommet<VertexType, ArcType>& s1, const Sommet<VertexType, ArcType>& s2) const{
